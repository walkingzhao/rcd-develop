#include "basemsgdialog.h"
#include "ui_basemsgdialog.h"

baseMsgDialog::baseMsgDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::baseMsgDialog)
{
    ui->setupUi(this);
}

baseMsgDialog::~baseMsgDialog()
{
    delete ui;
}
void baseMsgDialog::paintEvent(QPaintEvent *)
{
...
void baseMsgDialog::drawTip(QPainter &painter)
{
