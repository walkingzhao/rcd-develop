/********************************************************************************
** Form generated from reading UI file 'FastStopWgt.ui'
**
...
#ifndef UI_FASTSTOPWGT_H
#define UI_FASTSTOPWGT_H
...
public:
    ...
    void setupUi(QWidget *FastStopWgt)
    {
        if (FastStopWgt->objectName().isEmpty())
            FastStopWgt->setObjectName(QString::fromUtf8("FastStopWgt"));
        FastStopWgt->resize(843, 300);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(FastStopWgt->sizePolicy().hasHeightForWidth());
        FastStopWgt->setSizePolicy(sizePolicy);
        gridLayout = new QGridLayout(FastStopWgt);
        gridLayout->setSpacing(0);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        widget = new baseForm(FastStopWgt);
        ...
        retranslateUi(FastStopWgt);

        QMetaObject::connectSlotsByName(FastStopWgt);
    } // setupUi

    void retranslateUi(QWidget *FastStopWgt)
    {
        FastStopWgt->setWindowTitle(QCoreApplication::translate("FastStopWgt", "Form", nullptr));
        label_title->setText(QCoreApplication::translate("FastStopWgt", "\347\241\256\350\256\244\345\217\221\351\200\201\345\277\253\351\200\237\345\201\234\350\275\246\357\274\237", nullptr));
        label_task->setText(QString());
        pushButton_ok->setText(QCoreApplication::translate("FastStopWgt", "\347\241\256\350\256\244", nullptr));
        pushButton_cancel->setText(QCoreApplication::translate("FastStopWgt", "\345\217\226\346\266\210", nullptr));
    } // retranslateUi

};

namespace Ui {
    class FastStopWgt: public Ui_FastStopWgt {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FASTSTOPWGT_H
