/********************************************************************************
** Form generated from reading UI file 'CompleteOperEndWgt.ui'
**
...
#ifndef UI_COMPLETEOPERENDWGT_H
#define UI_COMPLETEOPERENDWGT_H
...
public:
    ...
    void setupUi(QWidget *CompleteOperEndWgt)
    {
        if (CompleteOperEndWgt->objectName().isEmpty())
            CompleteOperEndWgt->setObjectName(QString::fromUtf8("CompleteOperEndWgt"));
        CompleteOperEndWgt->resize(832, 300);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(CompleteOperEndWgt->sizePolicy().hasHeightForWidth());
        CompleteOperEndWgt->setSizePolicy(sizePolicy);
        gridLayout = new QGridLayout(CompleteOperEndWgt);
        gridLayout->setSpacing(0);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        widget = new baseForm(CompleteOperEndWgt);
...
"}"));
        ...
        retranslateUi(CompleteOperEndWgt);

        QMetaObject::connectSlotsByName(CompleteOperEndWgt);
    } // setupUi

    void retranslateUi(QWidget *CompleteOperEndWgt)
    {
        CompleteOperEndWgt->setWindowTitle(QCoreApplication::translate("CompleteOperEndWgt", "Form", nullptr));
        label_title->setText(QCoreApplication::translate("CompleteOperEndWgt", "\350\257\267\345\256\214\346\210\220\344\273\245\344\270\213\346\223\215\344\275\234\345\220\216\347\241\256\350\256\244\347\273\223\346\235\237\346\216\245\347\256\241\357\274\201", nullptr));
        gear->setText(QCoreApplication::translate("CompleteOperEndWgt", "\346\241\243\344\275\215P\346\241\243", nullptr));
        pedal->setText(QCoreApplication::translate("CompleteOperEndWgt", "\350\270\217\346\235\277\346\227\240\350\270\251\345\216\213", nullptr));
        centorWheel->setText(QCoreApplication::translate("CompleteOperEndWgt", "\346\226\271\345\220\221\347\233\230\345\233\236\346\255\243", nullptr));
        buttonReset->setText(QCoreApplication::translate("CompleteOperEndWgt", "\346\214\211\351\222\256\345\244\215\344\275\215", nullptr));
        pushButton_ok->setText(QCoreApplication::translate("CompleteOperEndWgt", "\347\241\256\350\256\244", nullptr));
        pushButton_cancel->setText(QCoreApplication::translate("CompleteOperEndWgt", "\345\217\226\346\266\210", nullptr));
    } // retranslateUi

};

namespace Ui {
    class CompleteOperEndWgt: public Ui_CompleteOperEndWgt {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_COMPLETEOPERENDWGT_H
