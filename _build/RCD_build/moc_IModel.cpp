...
#include <memory>
#include "../../RcdUi/src/Interface/IModel.h"
...
QT_MOC_LITERAL(1, 7, 15), // "sendModelUpdate"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3) // "cmd"

    },
    "IModel\0sendModelUpdate\0\0cmd"
};
...
void IModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<IModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendModelUpdate((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (IModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IModel::sendModelUpdate)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject IModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_IModel.data,
    qt_meta_data_IModel,
    qt_static_metacall,
    nullptr,
    nullptr
...
// SIGNAL 0
void IModel::sendModelUpdate(int _t1)
{
