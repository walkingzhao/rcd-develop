...
public:
    ...
    void setupUi(QWidget *MainMonitorWgt)
    {
        ...
        labelImei1->setGeometry(QRect(10, 10, 211, 21));
        ...
        labelImei2->setGeometry(QRect(10, 10, 211, 21));
        ...
        labelImei3->setGeometry(QRect(10, 10, 211, 21));
        ...
        labelImei4->setGeometry(QRect(10, 10, 211, 21));
        ...
        labelImei5->setGeometry(QRect(10, 10, 211, 21));
        ...
        labelImei6->setGeometry(QRect(10, 10, 211, 21));
        ...
        widget_date_dirver = new titleDateDriver(title);
        widget_date_dirver->setObjectName(QString::fromUtf8("widget_date_dirver"));
        widget_date_dirver->setGeometry(QRect(320, 260, 131, 81));
        label_rcd_version = new QLabel(title);
        label_rcd_version->setObjectName(QString::fromUtf8("label_rcd_version"));
        label_rcd_version->setGeometry(QRect(750, 580, 67, 17));
        layoutWidget = new QWidget(title);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(170, 170, 221, 131));
        gridLayout_msg = new QGridLayout(layoutWidget);
        gridLayout_msg->setObjectName(QString::fromUtf8("gridLayout_msg"));
        gridLayout_msg->setContentsMargins(0, 0, 0, 0);
    ...
    void retranslateUi(QWidget *MainMonitorWgt)
    {
        ...
        label_rcd_version->setText(QCoreApplication::translate("MainMonitorWgt", "TextLabel", nullptr));
    } // retranslateUi
